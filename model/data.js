...
Posteriormente aparecen en un apartamento visualmente normal con otras personas igual de desconcertadas que ellos. Allí, una misteriosa esfera negra les obliga a participar de un sádico juego y para ello les pone a su disposicion todo un exotico arsenal futurista que deberán aprender a usar para combatir a diversas especies de alienígenas y otras amenazas que para la gente común pasan desapercibidas.
Los que llegan a la habitacion no son vistos por los humanos mortales hasta que la esfera no los «suelta» después de cada mision. Una vez que cumplen una mision pueden llevarse el equipo que se les entrega (como un arma, un traje especial...) a su casa o a donde quiera que vayan.
Para cada mision se les da un tiempo limitado y cada vez que vuelven a la habitacion, si es que sobreviven, se les otorgan unos puntos dependiendo de como actuaron al enfrentarse al objetivo.`;
...
const attackTitanSinopsis = `La historia gira en torno a Eren Jaeger, su hermana adoptiva Mikasa Ackerman y su amigo Armin Arlert. En este mundo, la poblacion humana vive dentro de ciudades rodeadas de enormes muros para protegerse de la aparicion de seres gigantescos que devoran personas, los titanes. Un día, el muro más externo es atacado por un supertitán, y el resto de los titanes logran invadir la ciudad.`;
...
const demonSlayerSinopsis = `El escenario es la era Taisho de Japon. Tanjirou es un joven de buen corazon que vivio en paz con su familia como vendedor de carbon. Su vida normal cambia completamente cuando su familia es asesinada por demonios. La única otra sobreviviente, la hermana menor de Tanjirou, Nezuko, se ha convertido en un demonio feroz. Para devolver a Nezuko a la normalidad y vengarse del demonio que mato a su familia, los dos parten en un viaje. De un joven talento, comienza una historia de aventuras de sangre y espadas.`;
...
const dragonBallSSinopsis = `Dragon Ball Super es la secuela del Manga y anime de Dragon Ball Z después de la Saga de Majin Buu, y está enlazada con las películas Dragon Ball Z: La Batalla de los Dioses y Dragon Ball Z: La Resurreccion de F.`;
...
const hunterXSinopsis = `Los Hunters son personas que se dedican principalmente a rastrear tesoros, descubrir o cazar criaturas mágicas y algunas veces otros hombres. Pero, estas actividades requieren una licencia, y menos de uno entre cien-mil puede pasar el examen de cualificacion. Aquellos que logren pasar el duro examen se ganarán el acceso a áreas restringidas y el derecho a llamarse a si mismos Hunters.`;
...
const onePieceSinopsis = `La serie comienza con la ejecucion de Gol D. Roger, un hombre conocido como el Rey de los Piratas. Poco antes de su muerte, Roger hace mencion a su gran tesoro legendario, el One Piece, ya que puede ser tomado por todo aquél que lo desee. Esto marca el inicio de una era conocida como la Gran Era Pirata. Como resultado, un sinnúmero de piratas zarparon hacia Grand Line con el objetivo de encontrarlo`;
...
const onePunchSinopsis = `La historia tiene lugar en una metropolis ficticia conocida como Ciudad Z, en Japon. El mundo se ve invadido por extraños monstruos que aparecen misteriosamente y que causan numerosos desastres a la poblacion. Saitama es un poderoso superhéroe calvo que derrota fácilmente a los monstruos u otros villanos con un único golpe de su puño. Debido a esto, Saitama ha encontrado aburrida su fuerza y siempre está tratando de encontrar rivales más poderosos que le puedan igualar.`;
...
const saintSeiyaSinopsis = `Cada vez que el mal invade el mundo, aparecen para combatirlo los Caballeros del Zodiaco, guiados por la diosa Atena, como desde la antigüedad. Nuevamente esto ocurre y el encargado de hacerle frente será Seiya, un joven huérfano japonés que es enviado a Grecia para convertirse en caballero de bronce. Una vez de regreso a Japon se reencontrará con sus amigos de la infancia quienes también se han vuelto caballeros tras haber entrenado por años. Ahora competirán entre ellos por ver quién vestirá la armadura de oro de Sagitario. Pero esto no será posible, una vez que sea robada por encargo del Patriarca del Santuario en Grecia, quien se ha pasado del lado del mal. Entonces, los caballeros deberán unirse para defender a la humanidad y proteger a la reencarnacion de la diosa Atena, la joven Kido Saori .`;
let saintSeiya = new Comic('Saint Seiya', 'Mitología', saintSeiyaSinopsis, true, 'https://www.youtube.com/embed/Bu533OKYHyc', './assets/saintSeiya.jpg', 'EDITORIAL PANINI MANGA', '13.28', 'Finalizado');
...
const xmenSinopsis = `Hace poco, los Nuevos Mutantes regresaron de una mision en el espacio Shiar y trajeron con ellos un fascinante y extraño objeto que será la causa de una terrible lucha para evitar la destruccion total de su hogar. Mientras tanto, Forge se entera que su antiguo invento, del cual se arrepiente y avergüenza de haber creado, está siendo usado por los enemigos de la raza mutante para eliminarla.
Hace meses Domino fue capturada y desollada, sus tejidos fueron usados para diseñar asesinos aumentados genéticamente. Desde entonces, sus poderes de suerte han disminuido. Siguiendo una ola de asesinatos imposibles, Domino persiguio a una asesina que parece tener tanta suerte como ella solía tener y que está intentando detener a toda costa la presentacion de una legislacion pro-mutantes a la Cámara. Gracias a un golpe de intuicion, Sage descubrio el origen de la extraña suerte que acompaña a esos asesinatos. Domino y Colossus intentarán destruir la proliferacion de los codiciados y misteriosos tréboles.
Después de que X-Force asalto secretamente Terra Verde, se creyo que la amenaza telefloronica había sido superada. Pero ahora el país está completamente incomunicado. X-Force se encontro frente a una Terra Verde completamente transformada en una selva inexplorada donde la amenaza telefloronica destruyo todo rastro de vida.
Mientras rescataba a unos mutantes en la Bahía de Madripoor, la capitana Kate Pryde fue traicionada y asesinada. A medida que la tripulacion de la Marauder se enteraba de lo ocurrido, su pesar rápidamente se volvio ira contra sus múltiples enemigos. Los “grandes cerebros” están agotando hasta el último recurso en sus manos para revivirla, pero… lo lograrán ¿o es una mision imposible?`;
...
const milesmoralesSinopsis = `La vida de Miles como SPIDER-MAN es una batalla constante. Supervillanos, trabajos escolares, equilibrar una vida personal con sus responsabilidades como héroe, hijo y hermano... pero cada vez que cae, Miles se levanta más fuerte que antes. La CORPORACIoN BEYOND denuncio a Miles por infraccion del nombre y la imagen de Spider-Man. Ellos tienen a su propio Spidey, BEN REILLY. Miles y su clon Shift, se abrieron camino a través del escondite del ASESOR , derrotando al poderoso QUANTUM en el camino. Después de acabar con el Asesor para siempre, Miles se topo con los que parecían ser monitores.`;
...
const avengerIISinopsis = `Panini trae para ti la historia que redefinio no solo a la Comunidad Superheroica, sino la forma de entender el deber y la libertad: CIVIL WAR. Absolutamente nadie está por encima de la ley, pero nada positivo surge de un estado totalitario. Un incidente ha segado varias vidas y alguien debe hacerse responsable. El encono de la poblacion exige acciones contundentes, pero cuando uno de los principales héroes se rehúsa a ir en contra de aquellos que arriesgan sus vidas para proteger a la nacion, se desata el caos, y los héroes deberán elegir un bando, ¡pues todos están convencidos de que su postura es la única que creará un mundo mejor!`;
...
const starwarsSinopsis = `Alba Escarlata amenaza con traer el caos a todos los rincones del Imperio; Vader, consternado ante tal osadía, decide entrar en accion para establecer el orden en la Galaxia. Así, reúne a un extraño grupo de héroes y asesinos para exterminar a todos los criminales infiltrados en el gobierno y la milicia. Mientras tanto, Sabé sigue el rastro del Señor Oscuro y descubre pistas de su verdadera relacion con Padme.`;
...
const xmenIIISinopsis = `Comienza Amanecer X ¡Es el inicio de la saga de Cyclops y su escuadron cuidadosamente seleccionado de poderosos mutantes! Los Marauders Storm, Pyro, Bishop y Iceman navegan por los mares del mundo para proteger a sus compañeros genéticos, dirigidos por la capitana Kate Pride. Están financiados por Emma Frost y la Compañía Distribuidora Hellfire. Mientras tanto, en la Tierra, X-Force es la CIA del mundo mutante: mitad rama de inteligencia: Bestia, Jean Grey y Sage y mitad operaciones especiales: Wolverine, Kid Omega y Domino. ¡En un mundo perfecto no habría necesidad de X-Force!`;
let xmenIII = new Comic('X-MEN (2023) 01', 'Ciencia Ficcion', xmenIIISinopsis, true, 'https://www.youtube.com/embed/qrS4cTKINfI', './assets/xmenIII.jpg', 'EDITORIAL PANINI MARVEL', '13.28', 'Finalizado');

const starwarsIISinopsis = `Mientras la Rebelion intenta reunir sus fuerzas para hacer un último esfuerzo por derrotar al malvado Imperio Galáctico, Luke se da cuenta de que es momento de dar el siguiente paso en su camino a convertirse en Jedi. Pero si la Orden Jedi ya no existe, ¿en donde puede hallar el legado que necesita tan desesperadamente? La voz del Maestro Yoda será una pieza clave en este viaje, pero Yoda no enseñará a Luke la leccion que este debe aprender. ¡Esa leccion tomará (y también le dará) mucho más de lo que el joven Skywalker había imaginado! Asimismo, comienza la cacería final entre la comandante Ellian Zahra y la General Leia Organa. Además, luego de una mision que salio mal, la piloto rebelde Shara Bey, madre de Poe Dameron, quedo rezagada a bordo de un destructor estelar y ya no tiene mucho tiempo. ¡Todo esto y una celebracion de Star Wars que abarca la Galaxia entera!`;
