...
let gantz = new Comic('Gantz', 'Ciencia Ficcion', gantzSinopsis, true, 'https://youtu.be/SJ5ICtGn6u8', '/assets/gantz.jpg', 'EDITORIAL PANINI MANGA', '13.25', 'Finalizado');
...
let attackTitan = new Comic('Shingeki no Kyojin', 'Accion', attackTitanSinopsis, true, 'https://youtu.be/AgBUP8TJqV8', '/assets/attackTitan.jpg', 'EDITORIAL PANINI MANGA', '11.74', 'Finalizado');
...
let bleach = new Comic('Bleach', 'Sobrenatural', bleachSinopsis, true, 'https://youtu.be/92TEcszkRBw', '/assets/bleach.jpg', 'EDITORIAL PANINI MANGA', '9.50', 'Finalizado');
...
let demonSlayer = new Comic('Kimetsu no Yaiba', 'Sobrenatural', demonSlayerSinopsis, true, 'https://youtu.be/vFFyX928D9k', '/assets/demonSlayer.jpg', 'EDITORIAL PANINI MANGA', '7.84', 'Finalizado');
...
let dragonBallS = new Comic('Dragon Ball Super', 'Accion', dragonBallSSinopsis, true, 'https://youtu.be/j61ts42E2Ms', '/assets/dragonBallS.jpg', 'EDITORIAL PANINI MANGA', '12.55', 'Publicandose');
...
let heroAcademy = new Comic('Boku no Hero Academia', 'Accion', heroAcademySinopsis, true, 'https://youtu.be/iBRH9Po3gw8', '/assets/heroAcademy.jpg', 'EDITORIAL PANINI MANGA', '14.27', 'Publicandose');
...
let hunterX = new Comic('Hunter X Hunter', 'Aventura', hunterXSinopsis, true, 'https://youtu.be/faqmNf_fZlE', '/assets/hunterX.jpg', 'EDITORIAL PANINI MANGA', '6.50', 'Publicandose');
...
let naruto = new Comic('Naruto', 'Aventura', narutoSinopsis, true, 'https://youtu.be/b5W7aMKQdkU', '/assets/naruto.jpg', 'EDITORIAL PANINI MANGA', '7.65', 'Finalizado');
...
let onePiece = new Comic('One Piece', 'Aventura', onePieceSinopsis, true, 'https://youtu.be/MSXr7O0hu-c', '/assets/onePiece.jpg', 'EDITORIAL PANINI MANGA', '10.15', 'Publicandose');
...
let onePunch = new Comic('One Punch Man', 'Accion', onePunchSinopsis, true, 'https://youtu.be/erQURy_Ys5Y', '/assets/onePunch.jpg', 'EDITORIAL PANINI MANGA', '9.54', 'Publicandose');
...
let saintSeiya = new Comic('Saint Seiya', 'Mitologia', saintSeiyaSinopsis, true, 'https://youtu.be/Bu533OKYHyc', '/assets/saintSeiya.jpg', 'EDITORIAL PANINI MANGA', '13.28', 'Finalizado');
...
let sevenSins = new Comic('Nanatsu no Taizai', 'Aventura', sevenSinsSinopsis, true, 'https://youtu.be/x2ex07fceig', '../assets/sevenSins.jpg', 'EDITORIAL PANINI MANGA', '8.26', 'Finalizado');
...
let xmen = new Comic('X-MEN (2023) 05', 'Ciencia Ficcion', xmenSinopsis, true, 'https://youtu.be/sdwjlOSsR1M', '/assets/xmen.jpg', 'EDITORIAL PANINI MARVEL', '12.85', 'Finalizado');
...
let daredevil = new Comic('DAREDEVIL: EL HOMBRE SIN MIEDO', 'Accion', daredevilSinopsis, true, 'https://youtu.be/qDPtWLbL3QI', '/assets/daredevil.jpg', 'EDITORIAL PANINI MARVEL', '13.50', 'Finalizado');
...
let avenger = new Comic('AVENGERS (2023) 05', 'Accion', avengerSinopsis, true, 'https://youtu.be/fPNO7Q8rhOU', '/assets/avenger.jpg', 'EDITORIAL PANINI MARVEL', '7.84', 'Finalizado');
...
let xmenII = new Comic('X-MEN (2023) 03', 'Ciencia Ficcion', xmenIISinopsis, true, 'https://youtu.be/YeTZgBlpm2k', '/assets/xmenII.jpg', 'EDITORIAL PANINI MARVEL', '12.55', 'Publicandose');
...
let guardianes = new Comic('GUARDIANES DE LA GALAXIA', 'Ciencia Ficcion', guardianesSinopsis, true, 'https://youtu.be/_ZKZ_lQ5FWQ', '/assets/guardianes.jpg', 'EDITORIAL PANINI MARVEL', '14.27', 'Publicandose');
...
let milesmorales = new Comic('MILES MORALES: SPIDER-MAN', 'Aventura', milesmoralesSinopsis, true, 'https://youtu.be/FcP3zSpCHYM', '/assets/milesmorales.jpg', 'EDITORIAL PANINI COMIC', '6.50', 'Publicandose');
...
let wolverine = new Comic('WOLVERINE: LA LARGA NOCHE', 'Aventura', wolverineSinopsis, true, 'https://youtu.be/LVpO2nrPW2E', '/assets/wolverine.jpg', 'EDITORIAL PANINI MARVEL', '7.65', 'Finalizado');
...
let avengerII = new Comic('CIVIL WAR', 'accion', avengerIISinopsis, true, 'https://youtu.be/MrhOR5fii0w', '../assets/avengerII.jpg', 'EDITORIAL PANINI MARVEL', '10.15', 'Publicandose');
...
let starwars = new Comic('STAR WARS - DARTH VADER (2021) 04', 'Ciencia Ficcion', starwarsSinopsis, true, 'https://youtu.be/QYMETt578MM', '/assets/starwars.jpg', 'EDITORIAL PANINI COMIC', '9.54', 'Finalizado');
...
let xmenIII = new Comic('X-MEN (2023) 01', 'Mitologia', xmenIIISinopsis, true, 'https://youtu.be/qrS4cTKINfI', '/assets/xmenIII.jpg', 'EDITORIAL PANINI MARVEL', '13.28', 'Finalizado');
...
let starwarsII = new Comic('STAR WARS 04 - REINO ESCARLATA', 'Ciencia Ficcion', starwarsIISinopsis, true, 'https://youtu.be/_9FcJaEWIgg', '/assets/starwarsII.jpg', 'EDITORIAL PANINI COMIC', '8.26', 'Finalizado');
