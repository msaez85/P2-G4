...
let gantz = new Comic('Gantz', 'Ciencia Ficcion', gantzSinopsis, 'Si', 'https://youtu.be/SJ5ICtGn6u8', './assets/gantz.jpg', 'EDITORIAL PANINI MANGA', '13.25', 'Finalizado');
...
let attackTitan = new Comic('Shingeki no Kyojin', 'Accion', attackTitanSinopsis, 'Si', 'https://youtu.be/AgBUP8TJqV8', './assets/attackTitan.jpg', 'EDITORIAL PANINI MANGA', '11.74', 'Finalizado');
...
let bleach = new Comic('Bleach', 'Sobrenatural', bleachSinopsis, 'Si', 'https://youtu.be/92TEcszkRBw', './assets/bleach.jpg', 'EDITORIAL PANINI MANGA', '9.50', 'Finalizado');
...
let demonSlayer = new Comic('Kimetsu no Yaiba', 'Sobrenatural', demonSlayerSinopsis, 'Si', 'https://youtu.be/vFFyX928D9k', './assets/demonSlayer.jpg', 'EDITORIAL PANINI MANGA', '7.84', 'Finalizado');
...
let dragonBallS = new Comic('Dragon Ball Super', 'Accion', dragonBallSSinopsis, 'Si', 'https://youtu.be/j61ts42E2Ms', './assets/dragonBallS.jpg', 'EDITORIAL PANINI MANGA', '12.55', 'Publicandose');
...
let heroAcademy = new Comic('Boku no Hero Academia', 'Accion', heroAcademySinopsis, 'Si', 'https://youtu.be/iBRH9Po3gw8', './assets/heroAcademy.jpg', 'EDITORIAL PANINI MANGA', '14.27', 'Publicandose');
...
let hunterX = new Comic('Hunter X Hunter', 'Aventura', hunterXSinopsis, 'Si', 'https://youtu.be/faqmNf_fZlE', './assets/hunterX.jpg', 'EDITORIAL PANINI MANGA', '6.50', 'Publicandose');
...
let naruto = new Comic('Naruto', 'Aventura', narutoSinopsis, 'Si', 'https://youtu.be/b5W7aMKQdkU', './assets/naruto.jpg', 'EDITORIAL PANINI MANGA', '7.65', 'Finalizado');
...
let onePiece = new Comic('One Piece', 'Aventura', onePieceSinopsis, 'Si', 'https://youtu.be/MSXr7O0hu-c', './assets/onePiece.jpg', 'EDITORIAL PANINI MANGA', '10.15', 'Publicandose');
...
let onePunch = new Comic('One Punch Man', 'Accion', onePunchSinopsis, 'Si', 'https://youtu.be/erQURy_Ys5Y', './assets/onePunch.jpg', 'EDITORIAL PANINI MANGA', '9.54', 'Publicandose');
...
let saintSeiya = new Comic('Saint Seiya', 'Mitologia', saintSeiyaSinopsis, 'Si', 'https://youtu.be/Bu533OKYHyc', './assets/saintSeiya.jpg', 'EDITORIAL PANINI MANGA', '13.28', 'Finalizado');
...
let xmen = new Comic('X-MEN (2023) 05', 'Ciencia Ficcion', xmenSinopsis, 'Si', 'https://youtu.be/sdwjlOSsR1M', './assets/xmen.jpg', 'EDITORIAL PANINI MARVEL', '12.85', 'Finalizado');
...
let daredevil = new Comic('DAREDEVIL: EL HOMBRE SIN MIEDO', 'Accion', daredevilSinopsis, 'Si', 'https://youtu.be/qDPtWLbL3QI', './assets/daredevil.jpg', 'EDITORIAL PANINI MARVEL', '13.50', 'Finalizado');
...
let avenger = new Comic('AVENGERS (2023) 05', 'Accion', avengerSinopsis, 'Si', 'https://youtu.be/fPNO7Q8rhOU', './assets/avenger.jpg', 'EDITORIAL PANINI MARVEL', '7.84', 'Finalizado');
...
let xmenII = new Comic('X-MEN (2023) 03', 'Ciencia Ficcion', xmenIISinopsis, 'Si', 'https://youtu.be/YeTZgBlpm2k', './assets/xmenII.jpg', 'EDITORIAL PANINI MARVEL', '12.55', 'Publicandose');
...
let guardianes = new Comic('GUARDIANES DE LA GALAXIA', 'Ciencia Ficcion', guardianesSinopsis, 'Si', 'https://youtu.be/_ZKZ_lQ5FWQ', './assets/guardianes.jpg', 'EDITORIAL PANINI MARVEL', '14.27', 'Publicandose');
...
let milesmorales = new Comic('MILES MORALES: SPIDER-MAN', 'Aventura', milesmoralesSinopsis, 'Si', 'https://youtu.be/FcP3zSpCHYM', './assets/milesmorales.jpg', 'EDITORIAL PANINI COMIC', '6.50', 'Publicandose');
...
let wolverine = new Comic('WOLVERINE: LA LARGA NOCHE', 'Aventura', wolverineSinopsis, 'Si', 'https://youtu.be/LVpO2nrPW2E', './assets/wolverine.jpg', 'EDITORIAL PANINI MARVEL', '7.65', 'Finalizado');
...
let avengerII = new Comic('CIVIL WAR', 'accion', avengerIISinopsis, 'Si', 'https://youtu.be/MrhOR5fii0w', './assets/avengerII.jpg', 'EDITORIAL PANINI MARVEL', '10.15', 'Publicandose');
