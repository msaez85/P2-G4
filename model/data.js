...
let attackTitan = new Comic('Shingeki no Kyojin', 'Acción', attackTitanSinopsis, true, 'https://www.youtube.com/embed/AgBUP8TJqV8', './assets/attackTitan.jpg', 'EDITORIAL PANINI MANGA', '11.74', 'Finalizado');
...
let dragonBallS = new Comic('Dragon Ball Super', 'Acción', dragonBallSSinopsis, true, 'https://www.youtube.com/embed/j61ts42E2Ms', './assets/dragonBallS.jpg', 'EDITORIAL PANINI MANGA', '12.55', 'Publicandose');
...
let heroAcademy = new Comic('Boku no Hero Academia', 'Acción', heroAcademySinopsis, true, 'https://www.youtube.com/embed/iBRH9Po3gw8', './assets/heroAcademy.jpg', 'EDITORIAL PANINI MANGA', '14.27', 'Publicandose');
...
let onePunch = new Comic('One Punch Man', 'Acción', onePunchSinopsis, true, 'https://www.youtube.com/embed/erQURy_Ys5Y', './assets/onePunch.jpg', 'EDITORIAL PANINI MANGA', '9.54', 'Publicandose');
...
let daredevil = new Comic('DAREDEVIL: EL HOMBRE SIN MIEDO', 'Acción', daredevilSinopsis, true, 'https://www.youtube.com/embed/qDPtWLbL3QI', './assets/daredevil.jpg', 'EDITORIAL PANINI MARVEL', '13.50', 'Finalizado');
...
let avenger = new Comic('AVENGERS (2023) 05', 'Acción', avengerSinopsis, true, 'https://www.youtube.com/embed/fPNO7Q8rhOU', './assets/avenger.jpg', 'EDITORIAL PANINI MARVEL', '7.84', 'Finalizado');
...
let xmenII = new Comic('X-MEN (2023) 03', 'Ciencia Ficción', xmenIISinopsis, true, 'https://www.youtube.com/embed/YeTZgBlpm2k', './assets/xmenII.jpg', 'EDITORIAL PANINI MARVEL', '12.55', 'Publicandose');
...
let guardianes = new Comic('GUARDIANES DE LA GALAXIA', 'Ciencia Ficción', guardianesSinopsis, true, 'https://www.youtube.com/embed/_ZKZ_lQ5FWQ', './assets/guardianes.jpg', 'EDITORIAL PANINI MARVEL', '14.27', 'Publicandose');
...
let avengerII = new Comic('CIVIL WAR', 'Acción', avengerIISinopsis, true, 'https://www.youtube.com/embed/MrhOR5fii0w', './assets/avengerII.jpg', 'EDITORIAL PANINI MARVEL', '10.15', 'Publicandose');
...
let starwars = new Comic('STAR WARS - DARTH VADER (2021) 04', 'Ciencia Ficción', starwarsSinopsis, true, 'https://www.youtube.com/embed/QYMETt578MM', './assets/starwars.jpg', 'EDITORIAL PANINI COMIC', '9.54', 'Finalizado');
...
let xmenIII = new Comic('X-MEN (2023) 01', 'Ciencia Ficción', xmenIIISinopsis, true, 'https://www.youtube.com/embed/qrS4cTKINfI', './assets/xmenIII.jpg', 'EDITORIAL PANINI MARVEL', '13.28', 'Finalizado');
...
let starwarsII = new Comic('STAR WARS 04 - REINO ESCARLATA', 'Ciencia Ficción', starwarsIISinopsis, true, 'https://www.youtube.com/embed/_9FcJaEWIgg', './assets/starwarsII.jpg', 'EDITORIAL PANINI COMIC', '8.26', 'Finalizado');
